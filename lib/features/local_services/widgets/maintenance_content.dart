    ...
    return Column(
      ...
      children: [
        ...
        Row(
          spacing: 15.w,
          children: [
            Expanded(child: SpecialtyCard(title: 'local_services.plumbing'.tr(), onTap: () {})),
            Expanded(child: SpecialtyCard(title: 'local_services.electrical'.tr(), isSelected: true, onTap: () {})),
            Expanded(child: SpecialtyCard(title: 'local_services.furniture_assembly'.tr(), onTap: () {})),
          ],
        ),
        SizedBox(height: 32.h),

        // Added missing Service Card
        _buildSectionTitle('Premium Partners'),
        SizedBox(height: 24.h),
        
        PartnerCard(
          title: 'Elite Repairs'.tr(),
          description: 'Specialized in premium European fixtures,smart home integration, and aestheticstructural maintenance.'.tr(),
          rating: '4.8',
